...
namespace Team4_Ad
{
    public partial class UpdateRequisitionForm : System.Web.UI.Page
    {
        ...
        private void BindGrid(string Dpcode)
        {
            ...
            var c = entities.Requisitions.Where(p => p.Status == "Pending Approval"&& p.Employee.DepartmentCode.Equals(Dpcode))
                .Join(entities.Employees, m => m.EmployeeId, f => f.UserId, (m, f) => new { m.RequId, f.Name, m.RequestedDate, m.Status })
                .ToList();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Session["requid"] = RequId;
            Response.Redirect("SelectedRequisitionForm.aspx");
        }
