...
namespace Team4_Ad
{
    public partial class CompletedReqform : System.Web.UI.Page
    {
        ...
        private void BindGrid(string Dpcode)
        {
            ...
            var c = entities.Requisitions.Where(p => p.Status == "Completed" && p.Employee.DepartmentCode.Equals(Dpcode))
                .Join(entities.Employees, m => m.EmployeeId, f => f.UserId, (m, f) => new { m.RequId, f.Name, m.RequestedDate, m.Status, m.ReceivedBy,m.CollectionDate })
                .ToList();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Session["completedrequid"] = RequId;
            Response.Redirect("CompletedReqFormDetails.aspx");
        }
