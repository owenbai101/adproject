<%@ Page Title="" Language="C#" MasterPageFile="~/1DepartmentEmployee/Employee.Master" AutoEventWireup="true" CodeBehind="WaitingForCollectionDetails.aspx.cs" Inherits="Team4_Ad.DepartmentEmployee.ApprovedRequisitionFormDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head1" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    <p>
  <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/1DepartmentEmployee/WaitingForCollection.aspx">&lt;&lt; Back</asp:HyperLink>
</p>
<div class="row">
  <div class="col-md-12">
    <div class="card">
       <div class="card-header card-header-primary">
          <h4 class="card-title">Waiting For Collection Requisition Form #<asp:Label ID="Label5" runat="server" Text="Label"></asp:Label>
           </h4>
             </div>
               <div class="card-body">
