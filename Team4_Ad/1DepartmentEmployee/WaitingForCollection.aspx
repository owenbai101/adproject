<%@ Page Title="" Language="C#" MasterPageFile="~/1DepartmentEmployee/Employee.Master" AutoEventWireup="true" CodeBehind="WaitingForCollection.aspx.cs" Inherits="Team4_Ad.ApprovedRequisitionForm" %>
  ...
  <div class="col-md-12">
    <div class="card">
       <div class="card-header card-header-primary">
          <h4 class="card-title">Waiting For Collection Requisition Form</h4>
             </div>
               <div class="card-body">
                   ...
                   <table class="table">
                      <thead class="text-primary">
                       ...
                       <tbody>
                         <tr>                       
                           <td colspan="4">
                              <asp:GridView ID="GridView1" Align ="center" runat="server" AutoGenerateColumns="False" AllowPaging="True"  BorderWidth="2"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="SignDate" HeaderText="SignDate" DataFormatString="{0:dd/MM/yyyy}"  readonly="true" SortExpression="SignDate" />
