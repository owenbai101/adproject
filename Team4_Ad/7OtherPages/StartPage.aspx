<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StartPage.aspx.cs" Inherits="Team4_Ad._7OtherPages.StartPage" %>
...
<body class="offline-doc">
  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
    <div class="container-fluid">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="#pablo"><img src="../images/logo.jpg" width="135"/></a>
      </div>
  ...
  <div class="page-header clear-filter">
    <div class="page-header-image" style="background-image: url('../assets/img/cover.jpg'); left: 0px; top: 3px;"></div>
    <div class="content-center">
      <div class="auto-style1">
        <div class="brand">
          ...
          <br/>
          <a class="btn btn-primary btn-round btn-lg" href="login.aspx">Log in</a>
        </div>
      </div>
    </div>
  </div>
