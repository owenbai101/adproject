<%@ Page Title="" Language="C#" MasterPageFile="~/6StoreSupervisor/Supervisor.Master" AutoEventWireup="true" CodeBehind="Chart_ItemSupplierComparison.aspx.cs" Inherits="Team4_Ad.Charts2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <table ID="Table1" runat="server">
        <tr>
            <td colspan="6">
                <h2>Item Supplier Comparison</h2>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td >
             ...
             ErrorMessage="* Please select an item category." ForeColor="Red"  ></asp:RequiredFieldValidator>
            </td>
            <td >
                Select Item:
            </td>
