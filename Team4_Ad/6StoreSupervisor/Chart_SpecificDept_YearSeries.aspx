<%@ Page Title="" Language="C#" MasterPageFile="~/6StoreSupervisor/Supervisor.Master" AutoEventWireup="true" CodeBehind="Chart_SpecificDept_YearSeries.aspx.cs" Inherits="Team4_Ad.StoreSupervisor.Chart_Dept_yearbreakdown" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <table ID="Table1" runat="server" style="width: 900px">
        <tr>
            <td colspan="6">
                <h2>Specific Department by Year series</h2>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td >
                ...
                <br /><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="DropDownList1" InitialValue="---Select---"
        ...
        <tr>
            ...
            <td colspan="5"> <asp:RadioButtonList ID="DeptList" CellPadding="3" RepeatDirection="Horizontal" runat="server" ></asp:RadioButtonList></td>
            
                </tr>
        <tr>
            <td></td>
            <td colspan="5"><asp:RequiredFieldValidator ForeColor="Red" runat="server" ID="DeptRequired" Display="Dynamic" ControlToValidate="DeptList" ErrorMessage="* Select a department"
   ></asp:RequiredFieldValidator></td>
        ...
        <tr>
            ...
            <td>
                ...
                ErrorMessage="* Value Required!" InitialValue="--Select--"></asp:RequiredFieldValidator>
                &nbsp
                <asp:CompareValidator ID="cv" ForeColor="Red" runat="server" ValidationGroup="g1" InitialValue="-1" 
                    ControlToValidate="EndYear" ControlToCompare="StartYear" Operator="GreaterThanEqual" Text="* End Year should be the same or after the Start year" 
                    Type="String" /> 
